...
layui.define(['element', 'common'], function (exports) {
    ...
    function getHtml(data) {
        data = data
        var ulhtml = '<ul class="layui-nav layui-nav-tree back_blue_a beg-navbar">';
        ...
        for (var i = 0; i < data.length; i++) {
            if ( data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0 ) {
                ...
                left_ul += '<li class="layui-nav-item " data-url="' + data[i].href + '" data-title="' + data[i].title + '" data-id="'+ data[i].id +'" id='+ data[i].id +'  parentId='+ data[i].parentId +'>'; //第一个div可以默认修改
            } else {
            ...
            if ( data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0 ) {
                ...
                ulhtml += '<ul class="layui-nav-child back_blue_a  " style="padding-left: 15px;">'
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    if( data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0 ){
                        ulhtml += '<li class="layui-nav-item "  data-url="' + data[i].children[j].href + '" data-title="' + data[i].children[j].title + '" data-id="'+ data[i].children[j].id +'" title="' + data[i].children[j].title + '" id='+ data[i].children[j].id +'  parentId='+ data[i].children[j].parentId +'>';
                        left_ul += '<li class="layui-nav-item "  data-url="' + data[i].children[j].href + '" data-title="' + data[i].children[j].title + '" data-id="'+ data[i].children[j].id +'" title="' + data[i].children[j].title + '" id='+ data[i].children[j].id +'  parentId='+ data[i].children[j].parentId +'>';
                    }else{
                        ulhtml += '<li class="layui-nav-item site_active"  data-url="' + data[i].children[j].href + '" data-title="' + data[i].children[j].title + '" data-id="'+ data[i].children[j].id +'" title="' + data[i].children[j].title + '" id='+ data[i].children[j].id +'  parentId='+ data[i].children[j].parentId +'>';
                    ...
                    ulhtml += '<a href="javascript:;" data-url="' + data[i].children[j].href + '" data-title="' + data[i].children[j].title + '" data-id="'+ data[i].children[j].id +'">';
                    ...
                    if( data_l !== undefined && data_l !== null && data_l.length > 0   ){
                        ...
                        for( var l = 0 ; l <  data_l.length; l ++){
                            if ( data_l[l].children !== undefined && data_l[l].children !== null && data_l[l].length > 0 ) {
                                ...
                                ulhtml += '<li class="layui-nav-item " data-url="' + data_l[l].href + '" data-title="' + data_l[l].title + '" data-id="'+ data_l[l].id +'" title="' + data_l[l].title + '" id='+ data_l[l].id +'  parentId='+ data_l[l].parentId +'>';
                                left_ul += '<li class="layui-nav-item " data-url="' + data_l[l].href + '" data-title="' + data_l[l].title + '" data-id="'+ data_l[l].id +'" title="' + data_l[l].title + '" id='+ data_l[l].id +'  parentId='+ data_l[l].parentId +'>';
                            }
                            else {
                                ulhtml += '<li class="layui-nav-item site_active" data-url="' + data_l[l].href + '" data-title="' + data_l[l].title + '" data-id="'+ data_l[l].id +'" title="' + data_l[l].title + '" id='+ data_l[l].id +'  parentId='+ data_l[l].parentId +'>';
                            ...
                            ulhtml += '<a href="javascript:;" data-url="' + data_l[l].href + '" data-title="' + data_l[l].title + '" data-id="'+ data_l[l].id +'">' ;
                            if (data_l[l].icon !== undefined && data_l[l].icon !== '') {
                                if (data_l[l].icon.indexOf('fa-') !== -1) {
                                    ulhtml += '<i class="fa ' + data_l[l].icon + '" data-icon="' + data_l[l].icon + '" aria-hidden="true"></i>';
                                    left_ul += '<i class="fa ' + data_l[l].icon + '" data-icon="' + data_l[l].icon + '" aria-hidden="true"></i>';
                                } else {
                                    ulhtml += '<i class="layui-icon" data-icon="' + data_l[l].icon + '">' + data_l[l].icon + '</i>';
                                    left_ul += '<i class="layui-icon" data-icon="' + data_l[l].icon + '">' + data_l[l].icon + '</i>';
                                }
                            }
                            ulhtml += '<cite>' + data_l[l].title + '</cite>';
        ...
        $("#admin-navbar-side1").append( ulhtml );
        $("#admin-navbar-side2").append( ulhtml );
        $("#left_ul_one").append( ulhtml );
